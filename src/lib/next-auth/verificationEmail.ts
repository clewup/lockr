...
interface VerificationEmailRequestProps {
    identifier: string;
    url: string;
...
interface HTMLProps extends Omit<VerificationEmailRequestProps, 'provider'> {
    host: string;
}

export async function VerificationEmailRequest({ identifier, url, provider, theme }: VerificationEmailRequestProps) {
...
function html({ identifier, url, host, theme }: HTMLProps) {
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=OpenSans:wght@400;700&display=swap" rel="stylesheet" media="screen">
  <style>
    img {
      max-width: 100%;
    ...
    .hover-text-primary-600:hover {
      color: #661AE6 !important
    }
    .logo-heading-primary {
       color: #661AE6 !important;
       font-size: 36px;
    }
    .logo-text-primary {
                    ...
                    <tr>
                      <td class="sm-px-6" style="padding-left: 40px; padding-right: 40px">
                        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                              <a href="https://lockr.clewup.co.uk" class="logo-heading-primary" style="text-decoration: none; font-weight: 700; font-size: 36px; color: #661AE6">
                                Lockr
                              </a>
                            </td>
                            <td align="right">
                              <a href="https://lockr.clewup.co.uk/account" class="dark-text-gray-900 dark-bg-gray-50 hover-bg-slate-100" style="text-decoration: none; display: inline-block; border-radius: 8px; background-color: #f9fafb; padding: 7px 12px; text-align: center; font-size: 12px; font-weight: 700; color: #191847; box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.06), 0px 1px 3px rgba(0, 0, 0, 0.1)">
                                <!--[if mso
                                  ]><i
                                    style="
                                      letter-spacing: 24px;
                    ...
                    <tr>
                      <td class="sm-px-6" style="padding: 40px">
                        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                          ...
                          <tr>
                            <td>
                              <a href="${url}" class="sm-block dark-text-primary-500 hover-bg-primary-600 dark-bg-gray-50 dark-hover-bg-gray-50" style="text-decoration: none; display: inline-block; border-radius: 8px; background-color: #661AE6; padding: 14px 24px; text-align: center; font-size: 16px; font-weight: 700; color: #f9fafb; box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.06), 0px 4px 6px -1px rgba(0, 0, 0, 0.1)">
                                <!--[if mso
                                  ]><i
                                    style="
                                      letter-spacing: 24px;
          ...
          <table class="sm-w-full dark-text-gray-200" style="width: 568px; color: #767E9D" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td style="padding-left: 40px; padding-right: 40px">
                <a href="https://example.com" class="logo-text-primary" style="text-decoration: none; font-weight: 700; color: #661AE6">
                  Lockr
                </a>
                ...
                <table class="sm-w-full" style="font-size: 12px; line-height: 16px" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-block sm-w-full">
                      <a href="https://lockr.clewup.co.uk" class="sm-block sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; font-weight: 700; color: #767E9D">
                        Home
                      </a>
                    </td>
                    ...
                    <td class="sm-block sm-w-full">
                      <a href="https://twitter.com/clewup" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        Twitter
                      </a>
                    </td>
                    <td class="sm-block sm-px-0" style="padding-left: 12px; padding-right: 12px">
                    ...
                    <td class="sm-block sm-w-full">
                      <a href="https://github.com/clewup" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        GitHub
                      </a>
                    </td>
                  </tr>
                ...
                <table class="sm-w-full" style="font-size: 12px; line-height: 16px" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-block sm-w-full">
                      <a href="https://lockr.clewup.co.uk/terms" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        Terms of Service
                      </a>
                    </td>
                    <td class="sm-block sm-px-0" style="padding-left: 12px; padding-right: 12px">
                    ...
                    <td class="sm-block sm-w-full">
                      <a href="https://lockr.clewup.co.uk/privacy" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        Privacy Policy
                      </a>
                    </td>
                  </tr>
                ...
                <div style="line-height: 16px">&zwnj;</div>
                <p style="margin: 0; font-size: 12px; line-height: 16px">
                  This message was sent to ${identifier}. If you don't want to receive
                  these emails from Lockr in the future, you can
                  <a href="https://lockr.clewup.co.uk/account" class="hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; font-weight: 700; color: #767E9D">edit your profile</a>
                  or
                  <a href="https://lockr.clewup.co.uk/unsubscribe?email_address=${identifier}" class="hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; font-weight: 700; color: #767E9D">unsubscribe</a>.
                </p>
